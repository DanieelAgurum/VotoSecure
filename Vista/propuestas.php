...
<?php if (!$propuesta): ?>
    ...
    <!-- ── LISTADO — mismo estilo que candidatos.php ── -->
    <section class="candidates-section">

        <h2 class="fw-bold section-title">Propuestas de Candidatos</h2>
        ...
        <?php if (empty($propuestas)): ?>
            <div class="text-center py-5 my-5">
                <i class="bi bi-file-earmark-x" style="font-size:4rem;opacity:0.5;color:#adb5bd;"></i>
                <h3 class="mt-4 mb-1">No hay propuestas registradas</h3>
                <p class="lead text-muted">Las propuestas aparecerán aquí cuando los candidatos las publiquen.</p>
            </div>
        <?php else: ?>
